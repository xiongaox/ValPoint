 ...
 *
 * 主要导出：
 * - `ImageCompressOptions`、`convertBlobToJpegFile`、`convertBlobToWebpFile`、`compressClipboardImage`、`prepareClipboardImage`
 *
 * 依赖关系：
 * - 上游依赖：`../types/imageProcessing`
